...
export default async function RegisterPage({
  ...
  // Google OAuth is "create + sign in" in a single flow — the PrismaAdapter
  // creates the User row on first sign-in. So the same action used on /login
  // is correct here as the signup path.
  ...
  return (
    <div className="rounded-xl border border-border bg-card p-8 shadow-sm">
      ...
      <p className="mt-2 text-sm text-muted-foreground">
        Sign up with your email and a password{hasGoogle ? ", or with Google" : ""}.
      </p>
...
/** Multi-colored Google "G" mark — inlined SVG, no extra deps. */
function GoogleIcon() {
  return (
    <svg
      aria-hidden

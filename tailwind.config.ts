...
const config: Config = {
  ...
  theme: {
    ...
    extend: {
      colors: {
        // Brand — per-group override possible via inline CSS vars.
        // These defaults reflect the observed English To Work purple palette.
        brand: {
        ...
        presence: {
          ...
          away:   "hsl(var(--presence-away) / <alpha-value>)",
        },
      },
      borderRadius: {
        lg: "var(--radius)",
